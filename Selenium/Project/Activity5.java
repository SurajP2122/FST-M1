...
public class Activity5 {
    ...
    driver.findElement(By.xpath("//input[@id='personal_txtEmpFirstName']")).sendKeys("Suraj");
    driver.findElement(By.xpath("//input[@id='personal_txtEmpMiddleName']")).clear();
    driver.findElement(By.xpath("//input[@id='personal_txtEmpMiddleName']")).sendKeys("R");
    driver.findElement(By.xpath("//input[@id='personal_txtEmpLastName']")).clear();  
    driver.findElement(By.xpath("//input[@id='personal_txtEmpLastName']")).sendKeys("Patil");
